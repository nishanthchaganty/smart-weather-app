// Purpose is to clean data being passed into GPT for cost efficiency.
// Since, the only prediction needed for the news report is for today's
// weather, we can filter results to only pass in today's. GPT can handle limit
// context and very cost if for all the future trends and predictions as well.
